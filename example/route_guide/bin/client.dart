...
class Client {
  ...
  Future<void> main(List<String> args) async {
    ...
    channelContext.useCertificateChain('lib/assets/data/private.crt');
    channelContext.usePrivateKey('lib/assets/data/private.key');
    ...
    final channel = ClientChannel('127.0.0.1',
        port: 8080, options: ChannelOptions(credentials: channelCredentials));
    ...
    for (final count in benchmarkFeaturesCounts) {
      ...
      print("$count requests took ${sw.elapsedMilliseconds}ms");
    }
